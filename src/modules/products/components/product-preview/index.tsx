...
export default async function ProductPreview({
  ...
  return (
    <Container className="p-0 border h-full hover:border-primary-500 group" data-testid="product-wrapper">
          <Thumbnail
          ...
          <div className="p-3">
            <LocalizedClientLink href={`/products/${product.handle}`}>
              <Text className="group-hover:text-primary-500 text-xs md:text-xl group-hover:underline text-wrap line-clamp-2" data-testid="product-title">
                {product.title}
              </Text>
            </LocalizedClientLink>
            <div className="flex txt-compact-medium mt-4 gap-2 items-center justify-between font-cairo">
